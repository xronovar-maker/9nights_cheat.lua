...
local S = {
    ...
    AutoRespawn=false, AntiAFK=true,
    Aimbot=false, AimbotFOV=200, HitboxExpander=false, HitboxSize=3,
    WallClimb=false, RainMaker=false, SnowMaker=false, FireMaker=false,
}
...
Title.Text = "🌲 ULTIMATE FOREST MEGA HUB v4.1"
...
button(P3, "🌀 ТЕЛЕПОРТ ВСЕХ ПРЕДМЕТОВ КО МНЕ", 300, Color3.fromRGB(80, 160, 90), function()
...
button(P3, "🗑 УДАЛИТЬ ВСЕ ПРЕДМЕТЫ", 344, Color3.fromRGB(130, 60, 60), function()
    for _, obj in pairs(Workspace:GetDescendants()) do
...
toggle(P7, "🧊 Заморозить себя", 185, false, function(v)
    if LP.Character then
        local hrp = LP.Character:FindFirstChild("HumanoidRootPart")
...
toggle(P10, "✋ Тач-телепорт", 41, false, function(v) S.TouchTP=v end)
...
InfoL.Text = [[🌲 ULTIMATE FOREST MEGA HUB v4.1
━━━━━━━━━━━━━━━━━━━━━━━━━━━
📊 ВСЕГО ФУНКЦИЙ: 80+
...
print("[ULTIMATE FOREST v4.1] Загружено! 80+ функций.")